      ...
      try {
        ...
        if (data && data.length > 0) {
          const defaultCountry =
            data.find((c: any) => c.id === 1 || String(c.id) === "1") ||
            data[0];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof serverMessage === "object") {
        ...
        setError(
          serverMessage || "An unexpected error occurred during registration.",
        );
      }
    } finally {
      setLoading(false);
      ...
      <div className={styles.card}>
        ...
        <div className={styles.heading}>
          ...
          <p className={styles.subtitle}>
            {step === "register"
              ? "Get started managing your fleet with Drifully"
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.field}>
              <label htmlFor="reg-phone" className={styles.label}>
                Phone Number
                <span style={{ color: "#868C98", fontWeight: 400 }}>
                  (Optional)
                </span>
              </label>
            ...
            {/* Gender */}
            <div className={styles.field}>
              <label htmlFor="reg-gender" className={styles.label}>
                Gender
              </label>
              <div className={styles.inputWrap}>
                <svg
            ...
            {/* User Type */}
            <div className={styles.field}>
              <label htmlFor="reg-usertype" className={styles.label}>
                User Type
              </label>
              <div className={styles.inputWrap}>
                <svg
