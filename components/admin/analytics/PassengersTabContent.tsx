...
const DEFAULT_PASSENGER_ROWS: PassengerMetricRow[] = [
  {
    id: "1",
    passenger: "Prosper Edward",
    trips: 34,
    repeatTrip: 34,
    rating: 3,
    cancellationRate: "11.2%",
    lastTrip: "30 Jul 2026",
  },
  {
    id: "2",
    passenger: "Prosper Edward",
  ...
  },
  {
    ...
    rating: 5,
    cancellationRate: "2%",
    lastTrip: "14 Jun 2023",
  },
];

export default function PassengersTabContent() {
  ...
  const filteredRows = DEFAULT_PASSENGER_ROWS.filter((r) =>
          ...
          <tbody>
            {filteredRows.map((row) => (
              <tr key={row.id}>
                ...
                {/* Repeat Trip */}
                <td style={{ color: "#111827" }}>{row.repeatTrip}</td>
                ...
                {/* Last Trip */}
                <td style={{ color: "#111827" }}>{row.lastTrip}</td>
