...
const ROUTE_PERMISSIONS: Record<string, AdminRole[]> = {
  ...
  "/admin/passangers": ["Super Admin", "Admin", "Customer Engagement"],
...
export default function AdminGuard({
  ...
  const isAuthorized =
    !allowedRoles || allowedRoles.includes(currentRole as AdminRole);
      ...
      <div className={styles.forbidden} role="alert">
        <div className={styles.card}>
          ...
          <p className={styles.message}>
            Your role as{" "}
            <strong className={styles.roleHighlight}>{currentRole}</strong> does
