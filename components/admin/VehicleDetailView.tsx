...
export default function VehicleDetailView({
  ...
  const [activeImage, setActiveImage] = useState<string>(
    vehicle.image || "/images/3rd-img.png",
  );
  ...
  const getStatusClass = (status: string) =>
    statusClasses[status] || styles.statusAvailable;
        ...
        <div className={styles.headerLeft} style={{ display: "block" }}>
          ...
          <div className={styles.headerTitle}>
            ...
            <div className={styles.idRow}>
              ...
              <span
                className={`${styles.badge} ${getStatusClass(vehicle.status)}`}
              >
          ...
          <section className={styles.section} style={{ padding: 0 }}>
            ...
            <div className={styles.actionList}>
              <ActionButton
                ...
                onClick={() => onStatusChange(vehicle.id!, "booked")}
              />
              <ActionButton
...
function CopyIcon() {
  return (
    <Image src="/images/admin/copy.svg" alt="Copy" width={16} height={16} />
  );
}
