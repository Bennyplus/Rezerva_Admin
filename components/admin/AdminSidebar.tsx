    ...
    items: [
      {
        ...
        href: "/admin/trips",
        icon: "trips",
        allowedRoles: ["Super Admin", "Admin", "Fleet Manager", "Operations Manager"],
        children: [
          {
            label: "Vehicles",
            href: "/admin/vehicles",
      ...
      },
      {
        ...
        href: "/admin/safety",
        icon: "safety",
        allowedRoles: ["Super Admin", "Admin", "Customer Engagement", "Operations Manager"],
        children: [
          {
    ...
    items: [
      {
        ...
        allowedRoles: ["Super Admin", "Admin", "Customer Engagement"],
        children: [
          { label: "Teams", href: "/admin/teams", allowedRoles: ["Super Admin", "Admin"] },
          { label: "Drivers", href: "/admin/drivers", allowedRoles: ["Super Admin", "Admin", "Customer Engagement"] },
          { label: "Customers", href: "/admin/customers", allowedRoles: ["Super Admin", "Admin", "Customer Engagement"] }
        ]
      },
      {
        label: "Reviews",
                  ...
                  <li key={item.href}>
                    {item.children ? (
                      ...
                      <>
                          ...
                          {!collapsed && (
                            <svg
                              ...
                              className={`${styles.chevron} ${
                                expandedItems[item.label.toLowerCase()] ? styles.chevronOpen : ""
                              }`}
                            >
                        ...
                        {expandedItems[item.label.toLowerCase()] && !collapsed && (
